...
export const MOCK_WATCHES: TopicWatch[] = [
  ...
  },
  {
    id: 'watch-3',
    label: 'n8n・自動化ツール',
    keywords: ['n8n', 'ノーコード', 'RPA', '自動化', 'ワークフロー'],
    sourceUrls: ['https://n8n.io/blog/rss'],
    enabled: false,
    scoreThreshold: 40,
  },
]
...
export const MOCK_TOPICS: TopicDetail[] = [
  ...
  {
    id: 'topic-4',
    title: 'n8n v2.0リリース — AIエージェントノードが標準搭載、有償プランと機能比較',
    sourceUrl: 'https://n8n.io/blog/n8n-v2-release',
    relevanceScore: 76,
    summary: 'n8n v2.0でAIエージェントノードが標準搭載。Claude/GPT連携が格段に簡易化。自社の自動化パイプライン構築コストが下がる一方、有償プランとの機能差分を再確認する必要あり。アップグレードのROIを試算推奨。',
    contentSnippet: 'n8n has released version 2.0 with built-in AI agent nodes, making it easier than ever to integrate large language models into automation workflows. The new release includes native connectors for Claude and GPT-4...',
    createdAt: new Date(Date.now() - 1000 * 60 * 60 * 8).toISOString(),
    status: 'read',
    watchLabel: 'n8n・自動化ツール',
    model: 'mock',
  },
  {
    id: 'topic-5',
